package cn.cookie.framework.spring.mvc;
 ...
 * 	url root: /api/
 * 	cn.upenny.credit.api.action.UserAction 类的RequestMapping值为:user, 某成员方法的RequestMapping值为: /getUser, 则 转换后的完整url为: /api/user/getUser
 * 	cn.upenny.credit.api.action.v1_0_0.UserAction 类的RequestMapping值为user, 某成员方法的RequestMapping值为: /getUser, 则 转换后的完整url为: /api/1.0.0/user/getUser
 * 
 * @author qiancai
 *
 */
